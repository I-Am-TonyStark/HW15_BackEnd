...
<div style="text-align: center">
    ...
    <a href="search_account.jsp">Search an account</a><br/>
    <a href="unfollow_account.jsp">unFollow an account</a><br/>
    <a href="delete_account.jsp">UnFollow an account</a><br/>
